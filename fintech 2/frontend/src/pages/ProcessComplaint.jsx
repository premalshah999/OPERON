      ...
      <section className="panel process-layout__results">
        ...
        {result ? (
          <div className="result-stack">
            ...
            <div className="result-grid">
              <BaselineComparison analysis={result} />
              <article className="mini-panel">
                <p className="section-kicker">Compliance signals</p>
                <h4>{compliance?.risk_level ?? "Unknown risk"}</h4>
                <p>{compliance?.reasoning ?? "Compliance reasoning unavailable."}</p>
                <div className="timeline__chips">
                  {(compliance?.flags ?? []).slice(0, 4).map((flag) => (
